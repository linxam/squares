/**
 This game is like SameGame game :)
 I wrote it by learning the Processing programming language.
 Two functions i took from examples section on Processing website (https://processing.org/examples/)
 Feel free to change the game. And enjoy with coding and playing! :)
 
 Alexander Kilinkarov
 www.linxam.ru
 linxam@gmail.com
 */
...
class Menu {
  ...
  void drawAboutInfo() {
    ...
    text("Copyright © 2018 Alexander Kilinkarov", this.x+width/2, this.y+90+200+10+30+90);
    fill(30, 30, 200);
    text("www.linxam.ru", this.x+width/2, this.y+90+200+10+30+110);
    fill(this.menuColor);
    textSize(12);
